...
public class BookingsProcessor implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            if (myMsg instanceof Booking) {
            	Booking b = (Booking)myMsg;
            	System.out.println("Received Booking: " + b.getName() + " to destination: " + b.getDestination());
            } else {
    ...
    public void init(Context ctx) throws NamingException, JMSException {
        ...
        queueIn = (Queue) ctx.lookup("jms/hw9-queue-bookings");
    ...
    public static void main(String[] args) throws Exception {
        ...
        BookingsProcessor app = new BookingsProcessor();
        app.init(ic);
        app.receive();
    }
}